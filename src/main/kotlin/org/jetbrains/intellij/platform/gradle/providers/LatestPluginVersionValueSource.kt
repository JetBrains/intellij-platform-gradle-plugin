...
abstract class LatestPluginVersionValueSource : ValueSource<String, LatestPluginVersionValueSource.Parameters> {
    ...
    interface Parameters : ValueSourceParameters {
        /**
         * Directory used to cache the Maven metadata across Gradle invocations.
         */
        @get:Input
        @get:Optional
    ...
    override fun obtain() = coordinates.resolveLatestVersion(
        repositoryUrl = repositoryUrl,
        cacheDirectory = parameters.cacheDirectory.orNull?.let { Path.of(it) },
