...
internal inline fun <reified T : Any> Project.cachedProvider(
    crossinline block: () -> T?
): Provider<out T> =
...
internal inline fun <reified K : Any, reified V : Any> Project.cachedProvider(
...
@OptIn(ExperimentalTypeInference::class)
@OverloadResolutionByLambdaReturnType
internal inline fun <reified T : Any> ProviderFactory.cachedProvider(
...
@JvmName("cachedMapProvider")
internal inline fun <reified K : Any, reified V : Any> ProviderFactory.cachedProvider(
    objects: ObjectFactory,
    crossinline block: () -> Map<K, V>?
): Provider<out Map<K, V>> =
    provider { block().markedAsNonNull }.cached(objects)
...
@OptIn(ExperimentalTypeInference::class)
@OverloadResolutionByLambdaReturnType
internal inline fun <T : Any, reified S : Any> Provider<out T>.cachedMap(
    project: Project,
...
internal inline fun <T : Any, reified K : Any, reified V : Any> Provider<out T>.cachedMap(
    project: Project,
...
@OptIn(ExperimentalTypeInference::class)
@OverloadResolutionByLambdaReturnType
internal inline fun <T : Any, reified S : Any> Provider<out T>.cachedFlatMap(
    project: Project,
...
internal inline fun <T : Any, reified K : Any, reified V : Any> Provider<out T>.cachedFlatMap(
    project: Project,
...
@OptIn(ExperimentalTypeInference::class)
@OverloadResolutionByLambdaReturnType
internal inline fun <T : Any, U : Any, reified R : Any> Provider<out T>.cachedZip(
    project: Project,
...
internal inline fun <T : Any, U : Any, reified K : Any, reified V : Any> Provider<out T>.cachedZip(
    project: Project,
    right: Provider<out U>,
...
internal inline fun <reified T : Any> Provider<out T>.cached(
    project: Project
): Provider<out T> =
    cached(project.objects)

@JvmName("cachedList")
internal inline fun <reified T : Any> Provider<out List<T>>.cached(
    project: Project
): Provider<out List<T>> =
    cached(project.objects)

@JvmName("cachedMap")
internal inline fun <reified K : Any, reified V : Any> Provider<out Map<K, V>>.cached(
    project: Project
): Provider<out Map<K, V>> =
    cached(project.objects)

@JvmName("cachedSet")
internal inline fun <reified T : Any> Provider<out Set<T>>.cached(
    project: Project
): Provider<out Set<T>> =
    cached(project.objects)
...
internal fun <T : HasConfigurableValue> T.asImmutable() = apply {
    disallowChanges()
    finalizeValueOnRead()
}
...
internal val <T> T?.markedAsNonNull: T
    get() {
        markAsNonNull()
        return this
    }
...
@OptIn(ExperimentalContracts::class)
internal fun <T> T?.markAsNonNull() {
    contract {
