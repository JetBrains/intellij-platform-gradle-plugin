...
abstract class VerifyPluginTask : JavaExec(), RuntimeAware, PluginVerifierAware , Reporting<VerifyReportContainer> {
    ...
    /**
     * Container for verification reports generated by the IntelliJ Plugin Verifier.
     *
     * Output location is configured using [org.jetbrains.intellij.platform.gradle.reports.DefaultDirectoryReport.getOutputLocation].
     * Default value: [IntelliJPlatformExtension.PluginVerification.verificationReportsDirectory]
     *
     * Format of the reports is configured using [VerifyReportContainer.formats]
     * Default value: [IntelliJPlatformExtension.PluginVerification.verificationReportsFormats]
     *
     * @see org.jetbrains.intellij.platform.gradle.tasks.VerifyReportContainer
     * @see org.jetbrains.intellij.platform.gradle.reports.DefaultDirectoryReport.getOutputLocation
