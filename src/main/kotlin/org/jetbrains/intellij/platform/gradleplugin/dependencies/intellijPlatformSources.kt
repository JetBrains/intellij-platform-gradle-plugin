...
fun DependencyHandlerScope.intellijPlatformSources(
    ...
    version: String,
    configurationName: String = INTELLIJ_PLATFORM_SOURCES_CONFIGURATION_NAME,
...
fun DependencyHandlerScope.intellijPlatformSources(type: String, version: Provider<String>) = intellijPlatformSources(IntelliJPlatformType.fromCode(type), version)
