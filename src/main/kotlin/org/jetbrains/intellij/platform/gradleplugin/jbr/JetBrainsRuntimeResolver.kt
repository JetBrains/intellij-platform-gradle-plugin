...
import org.jetbrains.intellij.platform.gradleplugin.IntelliJPluginConstants.JETBRAINS_RUNTIME_VENDOR
import java.io.File
...
class JetBrainsRuntimeResolver(
    ...
    fun resolveDirectory(validate: (executable: Path) -> Boolean = { true }): Path? {
        ...
        return listOf(
             ...
             * To add a custom JetBrains Runtime, use [org.jetbrains.intellij.platform.gradleplugin.dependencies.jetbrainsRuntime]
