...
object IntelliJPluginConstants {
    ...
    const val VERIFICATION_REPORT_FORMAT_PLAIN = "plain"
    const val VERIFICATION_REPORT_FORMAT_HTML = "html"

    val VERIFICATION_REPORTS_DEFAULT_FORMATS = listOf(
        VERIFICATION_REPORT_FORMAT_PLAIN,
        VERIFICATION_REPORT_FORMAT_HTML
    )
}
