...
class IntelliJPluginGr extends IntelliJPlugin {
    ...
    private void configureInstrumentation(@NotNull Project project, @NotNull IntelliJPluginExtension extension) {
    ...
    private void configureTestTasks(@NotNull Project project, @NotNull IntelliJPluginExtension extension) {
    ...
    private void configurePublishPluginTask(@NotNull Project project) {
    ...
    private File resolveDistributionFile(@NotNull Project project) {
