...
class RunPluginVerifierTaskSpec : IntelliJPluginSpecBase() {
    ...
    fun `use ListProductsReleasesTask output on missing ideVersions property`() {
        ...
        buildFile.groovy(
            """
            import org.jetbrains.intellij.platform.gradleplugin.tasks.ListProductsReleasesTask.Channel
    ...
    fun `fail on Deprecated API usages`() {
        ...
        buildFile.groovy(
            """
            import org.jetbrains.intellij.platform.gradleplugin.tasks.RunPluginVerifierTask.FailureLevel
