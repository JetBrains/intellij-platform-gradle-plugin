    ...
    fun `print bundled plugins`() {
        build(Tasks.PRINT_BUNDLED_PLUGINS) {
            assertContains(
                ...
                TestNG-J (TestNG)
                com.android.tools.gradle.dcl (Gradle Declarative Support)
                ...
                com.intellij.ja (Japanese Language Pack / 日本語言語パック)
                com.intellij.java (Java)
                com.intellij.java-i18n (Java Internationalization)
                com.intellij.java.ide (Java IDE Customization)
                com.intellij.ko (Korean Language Pack / 한국어 언어 팩)
                com.intellij.marketplace (JetBrains Marketplace Licensing)
                com.intellij.marketplace.ml (Machine Learning in Marketplace)
                com.intellij.modules.json (JSON)
                com.intellij.notebooks.core (Notebook Files)
                ...
                com.intellij.settingsSync (Backup and Sync)
                com.intellij.tasks (Task Management)
                com.intellij.turboComplete (Turbo Complete)
                com.intellij.zh (Chinese (Simplified) Language Pack / 中文语言包)
                com.jetbrains.codeWithMe (Code With Me)
                com.jetbrains.performancePlugin (Performance Testing)
                com.jetbrains.performancePlugin.async (Async Profiler for IDE Performance Testing)
                com.jetbrains.sh (Shell Script)
                com.jetbrains.station (Station)
                hg4idea (Mercurial)
                intellij.git.commit.modal (Modal Commit Interface)
                intellij.indexing.shared.core (Shared Indexes)
                intellij.jupyter (Jupyter)
                intellij.platform.ijent.impl (Remote Execution Agent)
                ...
                org.jetbrains.plugins.gitlab (GitLab)
                org.jetbrains.plugins.gradle (Gradle-Java)
                org.jetbrains.plugins.gradle.analysis (Gradle-Java-Analysis)
