...
- Add `latestVersion(type) { … }` helpers for platform dependencies and custom testing tasks to resolve the latest available installer version via `ProductReleasesService` JetBrains/intellij-platform-gradle-plugin#1628
