...
The **IntelliJ Platform Gradle Plugin `2.0.0-beta1`** is a plugin for the Gradle build system to help configure environments for building, testing, verifying, and publishing plugins for IntelliJ-based IDEs. It is a successor of _Gradle IntelliJ Plugin 1.x_.
...
[next]: https://github.com/JetBrains/gradle-intellij-plugin/compare/v2.0.0-beta1...HEAD
[2.0.0-beta1]: https://github.com/JetBrains/gradle-intellij-plugin/compare/v1.17.2...v2.0.0-beta1
