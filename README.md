...
buildscript {
  ...
  dependencies {
    classpath "gradle.plugin.org.jetbrains:gradle-intellij-plugin:0.2.5"
  }
}
...
- [AceJump plugin](https://github.com/johnlindquist/AceJump)  - Uses Gradle Script Kotlin
