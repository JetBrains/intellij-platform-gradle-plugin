...
| <kbd>downloadDirectory</kbd> - The path to directory where IDEs used for the verification will be downloaded.                                                            | `System.getProperty("plugin.verifier.home.dir")/ides` or `System.getProperty("user.home")/ides` or temporary directory. |
