...
| **Attributes**                                                                                                                                                           | **Default Value**                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| <kbd>ideVersions</kbd> - Array of IDEs to check, in `intellij.version` format, i.e.: `["IC-2019.3.5", "PS-2019.3", "IC-2020.2"]`. Should be set for the best experience. | <kbd>["${intellij.type}-${intellij.version}"]</kbd>                                                                                            |
...
*Check against IntelliJ Community and PhpStorm*

```
runPluginVerifier {
    ideVersions = ["PS-2019.3", "IC-2020.2"]
}
``` 
