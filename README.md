...
| **Attributes**                                                                                                                                                 | **Default Value**                                      |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| <kbd>ides</kbd> - Array of IDEs to check, in `intellij.version` format, like: `IC-2020.2`; if not set, uses `intellij`. Should be set for the best experience. | <kbd>["${intellij.type}-${intellij.version}"]</kbd>    |
