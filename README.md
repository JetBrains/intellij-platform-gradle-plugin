...
| <kbd>configDirectory</kbd> Path to configuration directory | <kdb>${intellij.sandboxDirectory}/config</kbd> |
| <kbd>pluginsDirectory</kbd> Path to plugins directory | <kdb>${intellij.sandboxDirectory}/plugins</kbd> |
