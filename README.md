...
```groovy
plugins {
  id "org.jetbrains.intellij" version "0.3.8"
}
```
...
buildscript {
  ...
  dependencies {
    classpath "gradle.plugin.org.jetbrains.intellij.plugins:gradle-intellij-plugin:0.3.8"
  }
}
...
| <kbd>type</kbd> - The type of IDEA distribution.|**Acceptable Values:**    <ul>        <li><kbd>'IC'</kbd> - Community Edition. </li>        <li><kbd>'IU'</kbd> - Ultimate Edition. </li>        <li><kbd>'JPS'</kbd> - JPS-only. </li>        <li><kbd>'RD'</kbd> - Rider.</li>        <li><kbd>'MPS'</kbd> - MPS.</li>    </ul>**Default Value:** <kbd>'IC'</kbd>|
