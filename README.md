...
plugins {
  id "org.jetbrains.intellij" version "0.2.6"
}
```
...
buildscript {
  ...
  dependencies {
    classpath "gradle.plugin.org.jetbrains:gradle-intellij-plugin:0.2.6"
  }
}
